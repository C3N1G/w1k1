...
- [原理篇](#---)
  ...
  * [orw shellcode injection](#orw-shellcode-injection)
    ...
    + [沙盒](#--)
      - [prctl沙盒](#prctl--)
      - [seccomp函数库沙盒](#seccomp-----)
    + [open, read, write系统调用](#open--read--write----)
...
![image-20220324132752645](自救指南-Clown版.assets/image-20220324132752645.png)

#### whomai 查看当前登录用户

查看当前用户就可以知道当前用户的权限用户目录之类的东西, 在攻防的时候会比较常用

![image-20220324132813693](自救指南-Clown版.assets/image-20220324132813693.png)

#### cd 更改当前目录

如果想要进入哪个目录, 可以用cd命令来实现

![image-20220324132952937](自救指南-Clown版.assets/image-20220324132952937.png)

如果要返回上级目录可以用`cd ..`, 因为在Linux有两种比较特殊的目录, 一个就是`..`还有一个是`.`, 前者代表上级目录, 后者代表本地目录

![image-20220324133208529](自救指南-Clown版.assets/image-20220324133208529.png)

如果要返回上两级目录可以用`../..`, 同理三级也一样的原理

![image-20220324133412456](自救指南-Clown版.assets/image-20220324133412456.png)

如果只输入cd命令, 那么是进入当前用户的用户目录下

![image-20220324133519393](自救指南-Clown版.assets/image-20220324133519393.png)

#### ls 列出目录内容

如果要知道当前目录下有什么可以用该命令来查看

![image-20220324135450941](自救指南-Clown版.assets/image-20220324135450941.png)

如果要看指定目录的内容, 加上目录路径就行

![image-20220324135643272](自救指南-Clown版.assets/image-20220324135643272.png)

如果要查看内容的详细信息, 可以加上`-l`参数

![image-20220324135755626](自救指南-Clown版.assets/image-20220324135755626.png)

但其实还有一些隐藏文件还没有被列出来, 比如`.`和`..`就是特殊文件, 加上`-a`参数就可以

![image-20220324135913569](自救指南-Clown版.assets/image-20220324135913569.png)
...
![image-20220324140437689](自救指南-Clown版.assets/image-20220324140437689.png)

但是它有时搜索的东西无用的信息很多, 而且它的数据库每天只会更新一遍, 这就导致刚创建的文件会找不到

![image-20220324140716880](自救指南-Clown版.assets/image-20220324140716880.png)

#### whereis 搜寻

whereis只能搜寻二进制文件, 原始代码或者帮助文件, 不能查找其他东西

![image-20220324141416224](自救指南-Clown版.assets/image-20220324141416224.png)

注意它是根据文件索引库的内容去找的, 所以也不是所有的都能找到吧

![image-20220324141917470](自救指南-Clown版.assets/image-20220324141917470.png)

#### which 搜寻

which是通过PATH环境变量里的路径来搜寻文件的, 范围比whereis要小点

![image-20220324142022575](自救指南-Clown版.assets/image-20220324142022575.png)

#### find 搜寻

find命令是这几个中最强大的搜寻工具, 最简单的使用就是指定搜寻开始目录, 指定文件类型和指定文件名称进行搜索

![image-20220324145923262](自救指南-Clown版.assets/image-20220324145923262.png)

该指令为从`/`根目录开始, 搜寻文件类型为f(普通文件), 名称为level00(这里有没有引号都行)的文件, find还支持通配符模糊搜索

![image-20220324150132077](自救指南-Clown版.assets/image-20220324150132077.png)
...
![image-20220324150446441](自救指南-Clown版.assets/image-20220324150446441.png)

但是它返回的结构太多了, 这时候就需要经过grep过滤来查找我们需要的进程

![image-20220324150617230](自救指南-Clown版.assets/image-20220324150617230.png)
...
![image-20220324151229070](自救指南-Clown版.assets/image-20220324151229070.png)

连接文件

![image-20220324151306357](自救指南-Clown版.assets/image-20220324151306357.png)
...
![image-20220324151903292](自救指南-Clown版.assets/image-20220324151903292.png)

#### touch 创建文件

touch命令加文件名就可以创建一个空白文件

![image-20220324152025837](自救指南-Clown版.assets/image-20220324152025837.png)

#### mkdir 创建目录

mkdir加上目录名称就可以创建一个空目录

![image-20220324152150541](自救指南-Clown版.assets/image-20220324152150541.png)
...
![image-20220324152709244](自救指南-Clown版.assets/image-20220324152709244.png)

如果要赋值目录的话, 需要加参数`-r`指定被复制的目录

![image-20220324153030869](自救指南-Clown版.assets/image-20220324153030869.png)
...
![image-20220324153255588](自救指南-Clown版.assets/image-20220324153255588.png)

但是就是移动的过程中可以对文件重命名, 如果就移动到文件的当前目录下, 就造成了对文件的重命名功能, Linux中没有专门的重命名工具

![image-20220324153435947](自救指南-Clown版.assets/image-20220324153435947.png)
...
![image-20220324153705147](自救指南-Clown版.assets/image-20220324153705147.png)

但是删除目录有点区别, 如果是空目录, 可以用`rmdir`命令来删除

![image-20220324153846925](自救指南-Clown版.assets/image-20220324153846925.png)

但是如果目录下是有文件的, 那么删除就会报错, 你必须用rm命令并用`-r`参数指定要删除的目录

![image-20220324154007066](自救指南-Clown版.assets/image-20220324154007066.png)
...
![837c00fe7be1d9fd22384dfe481d14c2](自救指南-Clown版.assets/837c00fe7be1d9fd22384dfe481d14c2.png)

而hint函数里执行的代码就是创建一个"/bin/sh"进程, 也就是所谓的获取到shell, hint函数满足了三大步骤的第二个步骤可利用代码段

接着分析main函数, main函数的buf变量是一个局部变量, 所以它是存储在栈里, 这里的一个栈布局为

![663931d9ab6bbc906154d55d841b8edd](自救指南-Clown版.assets/663931d9ab6bbc906154d55d841b8edd.png)
...
![7818161093cc9ee4e17a81afd1cc061c](自救指南-Clown版.assets/7818161093cc9ee4e17a81afd1cc061c.png)
...
![e2f6c455de1eef94f687d6bf020f4604](自救指南-Clown版.assets/e2f6c455de1eef94f687d6bf020f4604.png)

接着执行到ret指令

![4f5667bb4d3b1551b3f3b32a882026af](自救指南-Clown版.assets/4f5667bb4d3b1551b3f3b32a882026af.png)

ret指令会跳转到当前栈顶的那个地址去接着执行代码

![afe27ba0f215fd25c5931f1a4b346700](自救指南-Clown版.assets/afe27ba0f215fd25c5931f1a4b346700.png)

最后就会执行system("/bin/sh")获取到shell

![663c6511adfaefd95240157c65624cb6](自救指南-Clown版.assets/663c6511adfaefd95240157c65624cb6.png)
...
![914b3545e6f55025021df0e20083da5d](自救指南-Clown版.assets/914b3545e6f55025021df0e20083da5d.png)

s是rbp或ebp, r是函数返回地址, 变量地址看具体情况, 我们这里示例的变量地址就是var_10, 所以中间的无关字节就是0x10+ebp或rbp栈帧大小=0x18
还有就是汇编学的好的话, 看汇编可以直接看出来

![b0eb6ffc7f3e4276e005025fbd4759aa](自救指南-Clown版.assets/b0eb6ffc7f3e4276e005025fbd4759aa.png)
...
![61b41b3ee7dfe5b32986acaf5a9384c9](自救指南-Clown版.assets/61b41b3ee7dfe5b32986acaf5a9384c9.png)

pwndbg会显示函数参数是什么, 而scanf第二个参数就是buf变量的地址

![59e8a4d3897ba6d19328da74bacf8681](自救指南-Clown版.assets/59e8a4d3897ba6d19328da74bacf8681.png)
...
![image-20220316183406736](自救指南-Clown版.assets/image-20220316183406736.png)
...
![image-20220316183437056](自救指南-Clown版.assets/image-20220316183437056.png)
...
![image-20220316183502124](自救指南-Clown版.assets/image-20220316183502124.png)

read函数溢出

![image-20220316183520590](自救指南-Clown版.assets/image-20220316183520590.png)

hint函数中存在int 0x80中断指令, 也可以用ROPgadget来查找中断指令

![image-20220316183535665](自救指南-Clown版.assets/image-20220316183535665.png)

接下来就是找传参的指令

![image-20220316183546362](自救指南-Clown版.assets/image-20220316183546362.png)

只找到ebx和eax的, ecx和edx没找到, 但是可以发现在run函数里有两条指令将ecx和edx置为0

![image-20220316183610534](自救指南-Clown版.assets/image-20220316183610534.png)

所以基本不需要我们去管, 执行ret指令的时候, ecx和edx已经为0

然后找程序里是否有"/bin/sh"字符串

![image-20220316183634706](自救指南-Clown版.assets/image-20220316183634706.png)

参数都准备齐了, 最后只需要栈布局就行

![image-20220316183645636](自救指南-Clown版.assets/image-20220316183645636.png)
...
![image-20220316183701353](自救指南-Clown版.assets/image-20220316183701353.png)

一样的, 最后执行完即可拿到shell

![image-20220316183714958](自救指南-Clown版.assets/image-20220316183714958.png)
...
![image-20220317191231435](自救指南-Clown版.assets/image-20220317191231435.png)
...
![image-20220317191336008](自救指南-Clown版.assets/image-20220317191336008.png)

read栈溢出

![image-20220317191351791](自救指南-Clown版.assets/image-20220317191351791.png)

NX保护也没有开启

![image-20220317191401969](自救指南-Clown版.assets/image-20220317191401969.png)

hint函数里面还包含一个jmp esp指令

那么就可以判断是shellcode注入了, 可以直接用pwntools的shellcode生成函数, 主要考虑的就是如何跳转到栈中的shellcode, 其实也挺简单的

![image-20220317191416266](自救指南-Clown版.assets/image-20220317191416266.png)
...
![image-20220317191448307](自救指南-Clown版.assets/image-20220317191448307.png)

可以看到jmp esp跳转的地方就是shellcode注入的地方, 执行完shellcode即可拿到shell

![image-20220317191459354](自救指南-Clown版.assets/image-20220317191459354.png)
...
![image-20220324121945612](自救指南-Clown版.assets/image-20220324121945612.png)

接着就会执行call指令跳转去执行printf函数

![image-20220324122931867](自救指南-Clown版.assets/image-20220324122931867.png)

程序反汇编后入栈顺序和上面所讲是一直的, 断点在call指令处, 看栈风水

![image-20220324123101521](自救指南-Clown版.assets/image-20220324123101521.png)
...
![image-20220324124446444](自救指南-Clown版.assets/image-20220324124446444.png)
...
![image-20220324124958091](自救指南-Clown版.assets/image-20220324124958091.png)

![image-20220324125021972](自救指南-Clown版.assets/image-20220324125021972.png)
...
![image-20220318164434495](自救指南-Clown版.assets/image-20220318164434495.png)

但是反汇编看到的两条call指令跳转的地方并不是函数的真实地址, 而是plt(过程链接表)

![image-20220318164654309](自救指南-Clown版.assets/image-20220318164654309.png)
...
![image-20220318172106738](自救指南-Clown版.assets/image-20220318172106738.png)
...
![image-20220318173638962](自救指南-Clown版.assets/image-20220318173638962.png)
...
![image-20220318183815838](自救指南-Clown版.assets/image-20220318183815838.png)

![image-20220318183507316](自救指南-Clown版.assets/image-20220318183507316.png)
...
![image-20220318184024535](自救指南-Clown版.assets/image-20220318184024535.png)
...
![image-20220318190037261](自救指南-Clown版.assets/image-20220318190037261.png)

动态调试来看看, 将断点设置在main的ret指令处

![image-20220318190232869](自救指南-Clown版.assets/image-20220318190232869.png)

可以看出来它将返回执行pop指令, 将'/bin/sh'弹入rdi, 继续执行到pop的ret指令处

![image-20220318190414616](自救指南-Clown版.assets/image-20220318190414616.png)
...
![image-20220318191113886](自救指南-Clown版.assets/image-20220318191113886.png)

这就需要借助gets函数来写入"/bin/sh"

![image-20220318191318563](自救指南-Clown版.assets/image-20220318191318563.png)

可以选择这种可写的区域来作为gets函数的参数, 这里我选择bss段来作为写入地方

还需要找指令将bss地址传入rdi作为参数

![image-20220318191533956](自救指南-Clown版.assets/image-20220318191533956.png)
...
![image-20220318193659536](自救指南-Clown版.assets/image-20220318193659536.png)
...
![image-20220318195648082](自救指南-Clown版.assets/image-20220318195648082.png)
...
![image-20220318200315040](自救指南-Clown版.assets/image-20220318200315040.png)

如果没有在正常的地方添加`o.recv`, 那么puts_addr其实是`who are you?`字符串的前6个字节

![image-20220318200454536](自救指南-Clown版.assets/image-20220318200454536.png)
...
![image-20220318201135271](自救指南-Clown版.assets/image-20220318201135271.png)
...
![image-20220318204245469](自救指南-Clown版.assets/image-20220318204245469.png)
...
![image-20220327164419246](自救指南-Clown版.assets/image-20220327164419246.png)
...
![image-20220327164852373](自救指南-Clown版.assets/image-20220327164852373.png)
...
![image-20220327165058730](自救指南-Clown版.assets/image-20220327165058730.png)
...
![image-20220327165234305](自救指南-Clown版.assets/image-20220327165234305.png)
...
![image-20220329151251769](自救指南-Clown版.assets/image-20220329151251769.png)
...
![image-20220329151916391](自救指南-Clown版.assets/image-20220329151916391.png)

你有没有思考过第三个数字是哪来的? 我们可以gdb调试来看一下, 将断点设置在`call printf`处来看printf的参数

![image-20220329152639177](自救指南-Clown版.assets/image-20220329152639177.png)
...
![image-20220329152723298](自救指南-Clown版.assets/image-20220329152723298.png)

第三个数转换为16进制为

![image-20220329152838759](自救指南-Clown版.assets/image-20220329152838759.png)
...
![image-20220329153219469](自救指南-Clown版.assets/image-20220329153219469.png)

x86程序参数传递是通过栈来传递, 那么按照x64程序的分析, 打印出的第三个数字在这里应该就是main+23的地址

![image-20220329153337600](自救指南-Clown版.assets/image-20220329153337600.png)

![image-20220329153411179](自救指南-Clown版.assets/image-20220329153411179.png)
...
![image-20220329154858852](自救指南-Clown版.assets/image-20220329154858852.png)

printf解析了我们的格式化控制符打印出了一些非预期的东西, 这些非预期的东西就是栈(或寄存器)内的东西

![image-20220329155538171](自救指南-Clown版.assets/image-20220329155538171.png)

![image-20220329155706014](自救指南-Clown版.assets/image-20220329155706014.png)
...
![image-20220329162227093](自救指南-Clown版.assets/image-20220329162227093.png)

这两个就是ser内容, 将十六进制转字符串

![image-20220329162251021](自救指南-Clown版.assets/image-20220329162251021.png)

小端序转换过来就是正常的`easy_format_leak`了, 我们可以调试来看看, 将断点设置在格式化字符串漏洞处

![image-20220329162411142](自救指南-Clown版.assets/image-20220329162411142.png)

我们可以看到执行到printf的时候, ser就存储在栈顶, 也就是第7, 8两个参数处(也就是第6, 7两个变量), 我们之前printf基础讲过, 可以通过`$`精准匹配参数, 所以这里可以直接输入`%6$p,%7$p`定位到ser

![image-20220329162647697](自救指南-Clown版.assets/image-20220329162647697.png)
...
![image-20220329164721614](自救指南-Clown版.assets/image-20220329164721614.png)

然后需要将这个地址写入到栈里给`%n`用

接下来我们需要gdb调试辅助来看一些东西, 把断点设置在格式化字符串漏洞处, 然后name输入"aaaaaaaa"

![image-20220329165151398](自救指南-Clown版.assets/image-20220329165151398.png)
...
![image-20220330221913912](自救指南-Clown版.assets/image-20220330221913912.png)
...
![image-20220330222039416](自救指南-Clown版.assets/image-20220330222039416.png)

还是gdb来调试看一下,把断点设置在格式化字符串漏洞处

![image-20220330222128189](自救指南-Clown版.assets/image-20220330222128189.png)

栈填充和我们预想的一样

![image-20220330222156233](自救指南-Clown版.assets/image-20220330222156233.png)

这时候num还没有被覆盖,单步执行

![image-20220330222228802](自救指南-Clown版.assets/image-20220330222228802.png)
...
![image-20220316213035929](自救指南-Clown版.assets/image-20220316213035929.png)
...
![image-20220316213324762](自救指南-Clown版.assets/image-20220316213324762.png)
...
![image-20220316214021047](自救指南-Clown版.assets/image-20220316214021047.png)
...
![image-20220316214251769](自救指南-Clown版.assets/image-20220316214251769.png)
...
![image-20220316214419033](自救指南-Clown版.assets/image-20220316214419033.png)
...
<img src="自救指南-Clown版.assets/f06909e06ba19230184b511f1dad6395.png" alt="f06909e06ba19230184b511f1dad6395" style="zoom:150%;" />

PR_SET_NO_NEW_PRIVS可以将调用线程的no_new_privs属性设置为arg2中的值，arg2设置为1，那么线程就不能通过execve系统调用进行提权，也就是说你获取一个shell，运行用户权限是啥，新shell权限就是啥
这个option只对execve有效

<img src="自救指南-Clown版.assets/b6b3f3b419f83a84cca2781f5bc46a43.png" alt="b6b3f3b419f83a84cca2781f5bc46a43" style="zoom:150%;" />
...
<img src="自救指南-Clown版.assets/204cc5277e5c8b7b64127e6de2605fbf.png" alt="204cc5277e5c8b7b64127e6de2605fbf" style="zoom:150%;" />
...
<img src="自救指南-Clown版.assets/57d76a6542b629294c89dcc10fdf0e60.png" alt="57d76a6542b629294c89dcc10fdf0e60" style="zoom: 150%;" />
...
![image-20220327140956008](自救指南-Clown版.assets/image-20220327140956008.png)
...
![image-20220327141559222](自救指南-Clown版.assets/image-20220327141559222.png)
...
![image-20220327142236878](自救指南-Clown版.assets/image-20220327142236878.png)
...
![image-20220327142856029](自救指南-Clown版.assets/image-20220327142856029.png)
...
![image-20220327143300050](自救指南-Clown版.assets/image-20220327143300050.png)
...
![image-20220327160933927](自救指南-Clown版.assets/image-20220327160933927.png)
...
![image-20220327162503371](自救指南-Clown版.assets/image-20220327162503371.png)
...
![image-20220317171822413](自救指南-Clown版.assets/image-20220317171822413.png)
...
![image-20220317172248525](自救指南-Clown版.assets/image-20220317172248525.png)

gdb看它的一个内存权限变化

![image-20220317172416365](自救指南-Clown版.assets/image-20220317172416365.png)

这是执行mprotect之前的权限

![image-20220317172516694](自救指南-Clown版.assets/image-20220317172516694.png)
...
![image-20220317173606044](自救指南-Clown版.assets/image-20220317173606044.png)

这道题中的所有函数地址都是固定的, 所以可以溢出覆盖来构造mprotect的rop链, 首先需要找一块可写内存来可供写入shellcode

![image-20220317173828774](自救指南-Clown版.assets/image-20220317173828774.png)

这里可以直接选这个区, 地址是固定的, 比较好利用, 由于是64位程序, 所以还需要搜寻一波`pop|ret`

![image-20220317174155661](自救指南-Clown版.assets/image-20220317174155661.png)
...
![image-20220317174918492](自救指南-Clown版.assets/image-20220317174918492.png)
...
![image-20220317175829405](自救指南-Clown版.assets/image-20220317175829405.png)

可能主要就是read那个rop链和shellcode注入那边有点问题, 可以调试来看一下

将断点设置在read rop链的返回执行read处

![image-20220317180310603](自救指南-Clown版.assets/image-20220317180310603.png)

可以看到这时候shellcode注入处还都是空的, 继续执行read函数 

![image-20220317180419985](自救指南-Clown版.assets/image-20220317180419985.png)

执行到read函数ret指令处可以看到它将返回到shellcode注入处去执行, 这时候shellcode已经通过`o.sendline(shellc)`注入到了这段区域

![image-20220317180534647](自救指南-Clown版.assets/image-20220317180534647.png)

![image-20220317180704505](自救指南-Clown版.assets/image-20220317180704505.png)

继续执行即可获取shell

![image-20220316183610534](自救指南-Clown版.assets/image-20220316183610534-16475858604237.png)
...
![image-20220320165558782](自救指南-Clown版.assets/image-20220320165558782.png)

但是.symtab不是必须的, .dynsym是必须的(因为动态链接器需要通过它来完成操作), 用readelf -S查看程序的所有节信息

![image-20220320170014843](自救指南-Clown版.assets/image-20220320170014843.png)

![image-20220320170034170](自救指南-Clown版.assets/image-20220320170034170.png)
...
![image-20220320171944794](自救指南-Clown版.assets/image-20220320171944794.png)

![image-20220320173550881](自救指南-Clown版.assets/image-20220320173550881.png)

name保存的是0x1BBh对应刚好是字符串的地址

![image-20220320173747736](自救指南-Clown版.assets/image-20220320173747736.png)

info保存的是STT_FUNC和STB_GLOBAL(从readelf中可以快速看出), 或者0x12的二进制为`0b10010`拆为两部分`0b1`和`0b0010`, 分别是1和2, 代表STB_GLOBAL和STT_FUNC

shndx为0xE也就是14

![image-20220320175113775](自救指南-Clown版.assets/image-20220320175113775.png)

代表的是text段(main在text段合情合理)

value存储的是main函数的偏移量

![image-20220320175327624](自救指南-Clown版.assets/image-20220320175327624.png)
...
![image-20220320181531289](自救指南-Clown版.assets/image-20220320181531289.png)

.symtab整个节都被删掉了

![image-20220320181856368](自救指南-Clown版.assets/image-20220320181856368.png)

文件大小也明显缩小了

![image-20220320182149144](自救指南-Clown版.assets/image-20220320182149144.png)

![image-20220320182058800](自救指南-Clown版.assets/image-20220320182058800.png)
...
![image-20220320193747263](自救指南-Clown版.assets/image-20220320193747263.png)

这是没有恢复的, 按shift+F5右击窗口选择Apply new signature

![image-20220320194338341](自救指南-Clown版.assets/image-20220320194338341.png)

或者通过File>Load file>FLIRT signature file 打开窗口

![image-20220320193955436](自救指南-Clown版.assets/image-20220320193955436.png)

选择合适的libc, 越是匹配的libc, 恢复的函数名就越多

![image-20220320194629123](自救指南-Clown版.assets/image-20220320194629123.png)

匹配了548个函数

![image-20220320194726116](自救指南-Clown版.assets/image-20220320194726116.png)

有的还没有被识别出来

![image-20220320194825698](自救指南-Clown版.assets/image-20220320194825698.png)
...
![image-20220317202035691](自救指南-Clown版.assets/image-20220317202035691.png)
...
![image-20220317202709010](自救指南-Clown版.assets/image-20220317202709010.png)

但是如果值搜索pop的话就什么都搜不到, 单纯的pop对于ROP链的帮助不是很大

![image-20220317202811976](自救指南-Clown版.assets/image-20220317202811976.png)
...
![image-20220317203204868](自救指南-Clown版.assets/image-20220317203204868.png)
...
![image-20220317204534952](自救指南-Clown版.assets/image-20220317204534952.png)
...
![image-20220317204715397](自救指南-Clown版.assets/image-20220317204715397.png)
...
![image-20220317204838143](自救指南-Clown版.assets/image-20220317204838143.png)
...
![image-20220317205056244](自救指南-Clown版.assets/image-20220317205056244.png)
...
![image-20220317205313334](自救指南-Clown版.assets/image-20220317205313334.png)
...
![image-20220320202719493](自救指南-Clown版.assets/image-20220320202719493.png)
...
![image-20220320200156825](自救指南-Clown版.assets/image-20220320200156825.png)
...
![image-20220327181143899](自救指南-Clown版.assets/image-20220327181143899.png)

程序很简单, 就是一个shellcode注入, 先看一下加的沙盒规则

![image-20220327180918049](自救指南-Clown版.assets/image-20220327180918049.png)
...
![image-20220327181512166](自救指南-Clown版.assets/image-20220327181512166.png)
...
![image-20220328180638257](自救指南-Clown版.assets/image-20220328180638257.png)

给定libc是2.23的版本

![image-20220328180710132](自救指南-Clown版.assets/image-20220328180710132.png)

add函数申请chunk的size限制在0~240之间

![image-20220328180815662](自救指南-Clown版.assets/image-20220328180815662-16484620965971.png)

delete函数有一个UAF漏洞

![image-20220328180942625](自救指南-Clown版.assets/image-20220328180942625.png)

edit函数没有什么问题

![image-20220328181010745](自救指南-Clown版.assets/image-20220328181010745.png)
